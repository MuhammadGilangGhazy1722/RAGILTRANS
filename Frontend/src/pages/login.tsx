  ...
  const handleSubmit = async (e: Event) => {
    ...
    try {
      ...
      const response = await fetchAPI(API_ENDPOINTS.LOGIN, {
        method: 'POST',
        body: JSON.stringify({
          email: formData().identifier, // backend expect 'email' field
      ...
      if (response.user) {
        ...
        localStorage.setItem('userName', response.user.nama || response.user.username);
    ...
    <div class="min-h-screen bg-[#0B0B0B] flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div class="w-full max-w-md relative z-10">
        ...
        <div class="text-center mb-8">
          ...
          <p class="text-gray-400">Login ke akun RagilTrans Anda</p>
        </div>
        ...
        <div class="bg-gradient-to-br from-gray-900 to-black rounded-2xl border border-purple-900/30 p-8 card-hover">
          ...
          <div class="flex justify-center">
            <button 
              ...
              type="button"
              class="flex items-center justify-center gap-2 bg-gray-800 hover:bg-gray-700 text-white px-6 py-3 rounded-lg transition-all border border-gray-700 hover:border-gray-600"
            >
